...
if os.path.exists("./chapter6_pyqt/ProductList.db"):
    con = sqlite3.connect("./chapter6_pyqt/ProductList.db")
    cur = con.cursor()
else: 
    con = sqlite3.connect("./chapter6_pyqt/ProductList.db")
    cur = con.cursor()
...
#디자인 파일을 로딩
form_class = uic.loadUiType("./chapter6_pyqt/ProductList.ui")[0]
